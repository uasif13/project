/*
  bfs mpi no cuda
  compile: make bfs_mpi/bfs_mpi_no_cuda (mpicxx -o bfs bfs_mpi_no_cuda.cpp)
  run: mpirun -n <nprocs> bfs_mpi_no_cuda <no_of_nodes> <start_node> <end_node> <percent>
 */
#include <mpi.h>
#include <cmath>
#include <math.h>
...
int main(int argc, char * argv[]) {
  ...
  //  printf("my_rank: %d my_work: %d nprocs: %d no_of_nodes: %d edge: %d\n", my_rank, my_work, nprocs, no_of_nodes, dst_size);  
